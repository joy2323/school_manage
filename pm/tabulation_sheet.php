...
if(isset($_POST['cls']))
{
	...
	/*** first add section select, then come here*/
		//$sqlSubj="SELECT DISTINCT student_id FROM broad_sheet WHERE  class_id='$clss' && term='$tem' && session='$ses' && section='$sect'";
		...
		while($rowSubj=mysqli_fetch_array($querySubj))
		{
			...
			$sqlUpdateScr = "UPDATE broader_sheet SET term_avg='$totalScr', section_id='$sect' WHERE student_id='$student_subjid' && class_id='$clss' && term_id='$tem' && session='$ses' ";
			...
			<tr bgcolor="#1921e2">
				<tr>
					...
					<th colspan="4"><div> MATHEMATICS</div></th>
					 <th colspan="4"><div> CIVIC EDUCATION</div></th>
					...
					<th colspan="4"><div> MARKETING</div></th>
					 ...
					 <th colspan="4"><div> HOME MANAGEMENT</div></th>
        ...
        <section class="additional-info" >
            <div class="container" <?php echo $hide; ?>>
               ...
               <div  style="float:left; border: 3px ; height:50px;">
                ...
                <div class="form-group">
                    <button class="btn btn-success" type="submit">Start Result</button>
                </div>
                </form>
                </div>
