...
?>
View profile of <?php echo htmlentities($dnn['username']); ?> :
...
{
?>
<br /><a href="new_pm.php?recip=<?php echo urlencode($dnn['username']); ?>" class="big">Click here to Send a Private Message to <?php echo htmlentities($dnn['username'], ENT_QUOTES, 'UTF-8'); ?> </a>
<?php
}
	}
	else
...
?>
		...
		<div class="foot"><a href="users.php">Go to the users list&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</a> - <a href="http://localhost/app">Smart School</a></div></div>
	</body>
</html>