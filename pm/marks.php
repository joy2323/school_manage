...
$sql = "select distinct session from term_jss";
$q =  mysqli_query($con, $sql);
$sessions = mysqli_fetch_assoc($q);
$cy = date('Y');
$ps = ($cy-1)."/".$cy;
if (!array_search($ns, $sessions)) {
	$sessions[(count($sessions)+1)] = $ps;
}

$ns = $cy."/".($cy+1);
if (!array_search($ns, $sessions)) {
	$sessions[(count($sessions)+1)] = $ns;
}
rsort($sessions);
...
/*DISPLAYS SUBJECT NAME END*/
														...
														while($rows = mysqli_fetch_array($querys)){
																			...
																			$dl .= '</table>';
																			$dl .=	'<br><button class="add_field_button btn btn-info" style="float:right; margin-right:30px;">Save Result</button>';
																			$dl .= '</form>';
...
<html>
    ...
    <body>
		...
		<div id="cont" class="container">
				...
				<h3 class="col-sm-12">Select the relevant information</h3>
                <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4">
                            ...
                            <div class="form-group  col-md-4">
                                <button type="submit"  class="btn btn-success">Start Result</button>
                            </div>
                    </div>
