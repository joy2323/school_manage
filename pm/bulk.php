...
$spic="";
	if(isset($_POST['fn_1'])){
		...
		$i--;
		die("Operation successful!.<br>".$i." records added.<br><br><a href='bulk.php'>Continue...</a> ");
...
<script>
			...
			function addRow(){
				...
				newRow.innerHTML ='<br>'+i+'.&nbsp;&nbsp;&nbsp;<input type="text" name="fn_'+i+'" placeholder="Student name..."><input type="date" name="bd_'+i+'" placeholder="MM/DD/YYYY..."><select name="gd_'+i+'" ><option >Gender</option><option value=Male>MALE</option><option value=Female>FEMALE</option></select><input type="text" name="hs_'+i+'" placeholder="House..."><input type="text" name="ad_'+i+'" placeholder="Address..."><input type="text" name="ph_'+i+'" placeholder="Phone No..."><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="em_'+i+'" placeholder="E-mail"><input type="text" name="pw_'+i+'" placeholder="State..."><input type="text" name="pn_'+i+'" placeholder="Parent Name..."><input type="text" name="ht_'+i+'" placeholder="Home Town"><select name="cl_'+i+'"><option value=1>Select Class</option><option value=1>JSS 1</option><option value=2>JSS 2</option><option value=3>JSS 3</option><option value=4>SSS 1</option><option value=5>SSS 2</option><option value=6>SSS 3</option><option value=7>GRADUATE</option></select><select name="sc_'+i+'" ><option value=1>Select Section</option><option value=1>1A</option><option value=2>1B</option><option value=3>1C</option><option value=4>1D</option><option value=5>2A</option><option value=6>2B</option><option value=7>2C</option><option value=8>2D</option><option value=9>3A</option><option value=10>3B</option><option value=11>3C</option><option value=12>3D</option><option value=13>SSS 1A</option><option value=14>SSS 1B</option><option value=15>SSS 2A</option><option value=16>SSS 2B</option><option value=17>SSS 3A</option><option value=18>SSS 3B</option><option value=19>GRAD A</option><option value=20>GRAD B</option></select><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="rn_'+i+'" placeholder="Reg Number"><input type="text" name="lg_'+i+'" placeholder="L.G.C">  &emsp;<input type="button" onclick="removeRow(this)" value="-" title="Remove this row"><hr>';
		...
		//<input type="text" name="cl_'+i+'" placeholder="Form No e.g.  5">
    ...
    <body>
		...
		<div id="cont" style="margin: 20px; padding: 20px;">
			...
			<form action="bulk.php" method="post" >
				...
				1. &nbsp;&nbsp;<input type="text" name="fn_1" placeholder="Student name..."><input type="date" name="bd_1" placeholder="MM/DD/YYYY...">
<!--<input type="text" name="gd_1" placeholder="Gender...">-->
	<select name="gd_1" >
		...
		<option value=Female>FEMALE</option>
				...
				<input type="text" name="ht_1" placeholder="Home Town">

<!--<input type="text" name="cl_1" placeholder="Form No e.g. 5">-->
	<select name="cl_1" >
...
&nbsp; <!--<input type="text" name="sc_1" placeholder="Section">-->
	...
	<select name="sc_1" >
		...
		<option value=13>SSS 1A</option>
		<option value=14>SSS 1B</option>
		<option value=15>SSS 2A</option>
		<option value=16>SSS 2B</option>
		<option value=17>SSS 3A</option>
		<option value=18>SSS 3B</option>
		<option value=19>GRAD A</option>
		<option value=20>GRAD B</option>
	</select><br>
