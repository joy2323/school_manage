...
<!--<form action="http://www.zionhighschools.com.ng" method="post" target="_blank">
<p align="center"><input type="hidden" name="cmd" value="_s-xclick">
	<input type="image" src="./images/paypal-de.gif" name="submit" alt="Goto  Home" title="Goto  Home">
