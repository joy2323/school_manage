...
if($term1>0){
	...
	/*just to display Class name*/
				$sqlza = "SELECT * FROM class WHERE class_id='$form'";
				$queryza = mysqli_query($con, $sqlza);
				$rowza = mysqli_fetch_array($queryza);
				$cl_name=$rowza['name'];
...
<h5>NAME:&emsp;<?php echo $name; ?> &emsp;  Admission No:&emsp;<?php echo $admNo; ?> &emsp; Section: <?php echo $section_name; ?>
<!--Address Of Parent/Guardian: <?php echo $address; ?>--></h5>

<div>  <h5>Class:&emsp;<?php echo $cl_name; ?>&emsp;Session:&emsp;<?php echo $sessionValue; ?>&emsp;Term:&emsp;<?php echo $show;?></h5></div>
...
<?php
 ...
 if($form>3)
 {
	 if($ttt>=0 && $ttt<5.5){
	$remark="VERY POOR";
	 }elseif($ttt>=5.5 && $ttt<10.5){
	$remark="POOR";
	 }elseif($ttt>=10.5 && $ttt<15.5){
	$remark="FAIR";
	 }elseif($ttt>=15.5 && $ttt<20.5){
	$remark="GOOD";
	 }elseif($ttt>=20.5 && $ttt<25.5){
	$remark="VERY GOOD";
	 }elseif($ttt>=25.5 && $ttt<=30){
	$remark="EXCELLENT";
	 }else{
	$remark="-----";
		}
	 ...
	 if($ttt>=0 && $ttt<10.5){
	$remark="VERY POOR";
	 }elseif($termAvgReal>=10.5 && $ttt<20.5){
	$remark="POOR";
	 }elseif($ttt>=20.5 && $ttt<29.5){
	$remark="FAIR";
	 }elseif($ttt>=29.5 && $ttt<40.5){
	$remark="GOOD";
	 }elseif($ttt>=40.5 && $ttt<50.5){
	$remark="VERY GOOD";
	 }elseif($ttt>=50.5 && $ttt<=60){
	$remark="EXCELLENT";
	 }else{
	$remark="-----";
		}
...
$avg =0;
																	...
																	if($total>0){
																		...
																		<td><center><small> '.$remark.'</small></center></td>
                                                                        <!--<td> '.$teacher_name.'</td>-->
