									...
									if($counts > 0){
														...
														$dl = '
																('.$counts.') students Names are displayed for '.$ccc.'  '.$subnamel.'<br><hr><br><center>
																	...
																	<table width="70%" border="3" cellspacing="1" cellpadding="2" class="table table-hover">
																	<tr bgcolor="#1921e2">
																		<tr>
											                            <th><div>SN</div></th>
														...
														while($rows = mysqli_fetch_array($querys)){
																			...
																			$queryst1 = mysqli_query($con, $sqlst1);
																				...
																				';
																								...
																								{
																									$termAvg=0;
					$termAvgReal=0;																					for ($i=1;$i<=3;$i++)
																									{
																										$sql_disp="SELECT * FROM broad_sheet WHERE term='$i' && session='$ses' && student_id='$studid'";
																									...
																									$sqlst = "SELECT * FROM broader_sheet WHERE student_id='$studid' && term_id='$i' && session='$ses' ";
																								...
																								if($countf < 1){
																									...
																									$termAvgReal1=$termAvg/$countf;
																								}

																								$termAvgReal+=$termAvgReal1;
																							}

																									$termAvgReal=$termAvgReal/3;
...
<script>
		...
		<div id="cont">
               ...
               <div  style="float:left; border: 3px ; height:50px;">
                <form class="form-inline" method="post" action="#" <?php echo $hide; ?>>
             ...
             <!--   <select name="sub" class="form-control">
				...
				<select name="sectionss" class="form-control">
				...
				<input type="submit" value="Start Result" style="color:#000000;" class="btn btn-default">
                </form>
                </div>
