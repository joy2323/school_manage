...
<form action="#" method="POST" enctype="multipart/form-data">
	...
	<input name="price" class="form-control" type="text" placeholder="Price in Naira"><br><br>
	<input name="ssfile" type="file" class="form-control" ><br><br>
	<input type="submit" value="Upload" class="form-control"><br><br>
