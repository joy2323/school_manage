...
/* if($form>3)
 {
	 if($tot_result>=0 && $tot_result<=49){
		 ...
		 $remark="-";
	 	 ...
	 	 if($termAvgReal>=0 && $termAvgReal<=49){
		 $gtr="POOR RESULT";
		 $ar="YOU CAN DO BETTER NEXT TIME";
	 }elseif($termAvgReal>=50 && $termAvgReal<=59){
		 $gtr="WEAK PERFOMANCE";
		 $ar="PUT MORE EFFORT TO IMPROVE";
	 }elseif($termAvgReal>=60 && $termAvgReal<=79){
		 $gtr="A GOOD RESULT";
		 $ar="AN IMPRESIVE PERFOMANCE";
	 }elseif($termAvgReal>=80 && $termAvgReal<=89){
		 $gtr="A VERY GOOD RESULT";
		 $ar="A BRILLIANT RESULT";
	 }elseif($termAvgReal>=90 && $termAvgReal<=100){
 ...
 <h5>F9=Fail(0-49)&emsp; E8=Pass(50-54)&emsp; D7=Needs to improve(55-59)&emsp; C6=Satisfactory(60-64)&emsp;C5=Satisfactory(65-69)&emsp; C4=Satisfactory(70-74)&emsp; B3=Good(75-79)&emsp;B2=Good(80-84)&emsp;A1=Excellent(85-100)  </h4><br/></h5><br/>
																	';}
																	else
																	{
																		$result.='<h5>Exam Total:&emsp;'.$termAvg.'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;'. $termAvgReal.'</h5><br/><br>
 <h5>F=Fail(0-49)&emsp;&emsp;&emsp;&emsp;&emsp; P=Pass(50-59)&emsp;&emsp;&emsp;&emsp;&emsp; C=Credit(60-79)&emsp;&emsp;&emsp;&emsp;&emsp; A=Excellent(80-100)  </h4><br/></h5><br/>
';
...
<a href="http://www.rhimoniacademy.com/portal/index.php?admin/transport/<?php echo $end ;?>">Open-day</a>
