...
<html>
    ...
    <body >
        ...
        <div id="container">
            <div class="header">
                <!-- <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.gif" alt="OES"/><h3 class="headtext"> &nbsp;Al-BAYAN School e-test</h3><h4 style="color:#ffff00;text-align:center;margin:0 0 5px 5px;"><i>...Advancing knowledge through ICT</i></h4> -->
            </div>
                ...
                <div class="page">
                        ...
                        if(isset($_REQUEST['details'])) {
                            ...
                            if(mysql_num_rows($result)!=0) {
                                ...
                                ?>
                    <table cellpadding="2" cellspacing="5" border="2" style="background:#f402ff url(images/page.gif);text-align:left;line-height:10px;">
                        <tr>
                            <td colspan="2"><h3 style="color:#ff00cc;text-align:center;">Test Result</h3></td>
                        </tr>
                       ...
                       <tr>
                            <td colspan="2" ><hr style="color:#ff0000;border-width:1px; "/><span onclick="window.print()" style="cursor:pointer; color: blue; "><center>Print this Result</center></span></td>
                        </tr>
                    </table>
                                <?php
                    ...
                    <table cellpadding="10" cellspacing="5" border="2" class="datatable">
                        <tr>
                            <th>Q. No</th>
                            <th>Question</th>
