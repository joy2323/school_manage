...
?>
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            ...
                            <td><?php
                    $marks = 0;
                    if (strcmp($_SESSION['q1stdans'], "Nigeria") == 0)
                        $marks = $marks + 1;
                    if (strcmp($_SESSION['q2stdans'], "BillGates") == 0)
                        $marks = $marks + 1;
                    echo $marks;
?></td>
                        </tr>
                    ...
                    <table cellpadding="30" cellspacing="10" class="datatable">
                        ...
                        <tr>
                            <td>1</td>
                            <td>which among these countries is an Oil Producing country?</td>
                            <td>Nigeria</td>
...
?>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Who is the founder of Windows computer Operating system??</td>
                            <td>Bill Gates</td>
...
?>
                    <div class="tc">
                        ...
                        <textarea cols="100" rows="8" name="question" readonly style="width:96.8%;text-align:left;margin-left:2%;margin-top:2px;font-size:120%;font-weight:bold;margin-bottom:0;color:#0000ff;padding:2px 2px 2px 2px;">Who is the founder of Windows computer Operating system?</textarea>
                        <table border="0" width="100%" class="ntab">
                            <tr><td>&nbsp;</td></tr>
                            <tr><td >1. <input type="radio" name="answer" value="BillGates" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "BillGates") == 0) {
                                echo "checked";
                            } ?>> Bill Gate</input></td></tr>
...
?>
                            <div class="tc">
                                ...
                                <textarea cols="100" rows="8" name="question" readonly style="width:96.8%;text-align:left;margin-left:2%;margin-top:2px;font-size:120%;font-weight:bold;margin-bottom:0;color:#0000ff;padding:2px 2px 2px 2px;">which among these countries is an Oil Producing country?</textarea>
                                <table border="0" width="100%" class="ntab">
                                    <tr><td>&nbsp;</td></tr>
                                    <tr><td >1. <input type="radio" name="answer" value="Nigeria" <?php if ((strcmp($_SESSION['q1status'], "review") == 0 || strcmp($_SESSION['q1status'], "answered") == 0) && strcmp($_SESSION['q1stdans'], "Nigeria") == 0) {
                                echo "checked";
                            } ?>> Nigeria</input></td></tr>
